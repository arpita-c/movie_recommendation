...
concat_dropout = keras.layers.Dropout(0.75)(concat)
BatchNormalization()

concat_dropout = LSTM(1,return_sequences=True)(concat_dropout)
concat_dropout = Dropout(0.75)(concat_dropout)

BatchNormalization()
concat_dropout = Dense(1)(concat_dropout)

#dense = keras.layers.Dense(50,name='FullyConnected')(concat)
...
adam = Adam(lr=0.001)
model = keras.Model([user_input, movie_input], concat_dropout)
